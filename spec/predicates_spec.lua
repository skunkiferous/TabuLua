...
describe("predicates", function()
  ...
  describe("isIdentifier", function()
    it("returns true for valid identifiers", function()
      ...
      assert.is_true(predicates.isIdentifier("var_"))
      assert.is_true(predicates.isIdentifier("a"))
      assert.is_true(predicates.isIdentifier("_a"))
    end)
    ...
    it("returns false for invalid identifiers", function()
      ...
      assert.is_false(predicates.isIdentifier("_"))
    end)
  end)
  ...
  describe("isName", function()
    it("returns true for valid names", function()
      ...
      assert.is_true(predicates.isName("_foo.bar"))
      assert.is_true(predicates.isName("foo.bar_"))
      assert.is_true(predicates.isName("a"))
    end)
    ...
    it("returns false for invalid names", function()
      ...
      assert.is_false(predicates.isName("_"))
      assert.is_false(predicates.isName("_.foo"))
      assert.is_false(predicates.isName("foo._"))
      assert.is_false(predicates.isName("foo._.bar"))
    end)
  end)
  ...
  describe("isReservedName", function()
    it("returns true for 'self'", function()
      assert.is_true(predicates.isReservedName("self"))
    end)

    it("returns false for anything else", function()
      assert.is_false(predicates.isReservedName("Self"))
      assert.is_false(predicates.isReservedName("SELF"))
      assert.is_false(predicates.isReservedName("selfie"))
      assert.is_false(predicates.isReservedName("myself"))
      assert.is_false(predicates.isReservedName("nil"))
      assert.is_false(predicates.isReservedName(42))
      assert.is_false(predicates.isReservedName(nil))
      assert.is_false(predicates.isReservedName({}))
    end)
  end)

  describe("isTupleFieldName", function()
    it("returns true for _<integer> patterns", function()
      assert.is_true(predicates.isTupleFieldName("_0"))
      assert.is_true(predicates.isTupleFieldName("_1"))
      assert.is_true(predicates.isTupleFieldName("_2"))
      assert.is_true(predicates.isTupleFieldName("_42"))
      assert.is_true(predicates.isTupleFieldName("_999"))
    end)

    it("returns false for non-matching patterns", function()
      assert.is_false(predicates.isTupleFieldName("_"))
      assert.is_false(predicates.isTupleFieldName("_abc"))
      assert.is_false(predicates.isTupleFieldName("_1a"))
      assert.is_false(predicates.isTupleFieldName("1"))
      assert.is_false(predicates.isTupleFieldName(""))
      assert.is_false(predicates.isTupleFieldName("self"))
      assert.is_false(predicates.isTupleFieldName(42))
      assert.is_false(predicates.isTupleFieldName(nil))
      assert.is_false(predicates.isTupleFieldName({}))
    end)
  end)
