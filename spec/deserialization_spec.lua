...
describe("deserialization", function()
  ...
  describe("deserializeXML", function()
    ...
    it("should deserialize floats", function()
      local val, err = deserialization.deserializeXML("<number>3.14</number>")
      assert.is_nil(err)
      assert.equals(3.14, val)
    end)

    it("should deserialize special floats", function()
      local val, err = deserialization.deserializeXML("<number>nan</number>")
      assert.is_nil(err)
      assert.is_true(val ~= val)  -- NaN check

      val, err = deserialization.deserializeXML("<number>inf</number>")
      assert.is_nil(err)
      assert.equals(math.huge, val)
    ...
    it("should return error for missing closing number tag", function()
      local val, err = deserialization.deserializeXML("<number>3.14")
      assert.is_nil(val)
      assert.is_not_nil(err)
