...
describe("deserialization", function()
  ...
  describe("deserializeJSON (typed JSON)", function()
    ...
    it("should deserialize integers with type wrapper", function()
      local val, err = deserialization.deserializeJSON('{"integer":"42"}')
      assert.is_nil(err)
      assert.equals(42, val)
      assert.equals("integer", math.type(val))

      val, err = deserialization.deserializeJSON('{"integer":"-100"}')
      assert.is_nil(err)
      assert.equals(-100, val)
    end)
    ...
    it("should deserialize table with integers", function()
      local val, err = deserialization.deserializeJSON('[3,{"integer":"1"},{"integer":"2"},{"integer":"3"}]')
      assert.is_nil(err)
      assert.are.same({1, 2, 3}, val)
    end)

    it("should deserialize map encoding [0, [key, val], ...]", function()
      local val, err = deserialization.deserializeJSON('[0,["a",{"integer":"1"}]]')
      assert.is_nil(err)
      assert.equals(1, val.a)
    end)
    ...
    it("should deserialize mixed tables", function()
      -- [2, int1, int2, [key, val]]
      local val, err = deserialization.deserializeJSON('[2,{"integer":"1"},{"integer":"2"},["a","test"]]')
      assert.is_nil(err)
      assert.equals(1, val[1])
    ...
    it("should return error for invalid int wrapper", function()
      local val, err = deserialization.deserializeJSON('{"integer":"not_a_number"}')
      assert.is_nil(val)
      assert.is_not_nil(err)
  ...
  describe("deserializeXML", function()
    it("should deserialize <null/>", function()
      local val, err = deserialization.deserializeXML("<null/>")
      assert.is_nil(val)
      assert.is_nil(err)
    end)

    it("should deserialize empty string input as nil", function()
      local val, err = deserialization.deserializeXML("")
      assert.is_nil(val)
      assert.is_nil(err)
    end)

    it("should deserialize booleans", function()
      local val, err = deserialization.deserializeXML("<true/>")
      assert.is_true(val)
      assert.is_nil(err)

      val, err = deserialization.deserializeXML("<false/>")
      assert.is_false(val)
      assert.is_nil(err)
    end)

    it("should deserialize integers", function()
      local val, err = deserialization.deserializeXML("<integer>42</integer>")
      assert.is_nil(err)
      assert.equals(42, val)
      assert.equals("integer", math.type(val))
    end)
    ...
    it("should deserialize floats", function()
      local val, err = deserialization.deserializeXML("<float>3.14</float>")
      assert.is_nil(err)
      assert.equals(3.14, val)
    end)

    it("should deserialize special floats", function()
      local val, err = deserialization.deserializeXML("<float>nan</float>")
      assert.is_nil(err)
      assert.is_true(val ~= val)  -- NaN check

      val, err = deserialization.deserializeXML("<float>inf</float>")
      assert.is_nil(err)
      assert.equals(math.huge, val)
    ...
    it("should deserialize strings", function()
      local val, err = deserialization.deserializeXML("<string>hello</string>")
      assert.is_nil(err)
      assert.equals("hello", val)
    end)

    it("should deserialize empty strings", function()
      local val, err = deserialization.deserializeXML("<string/>")
      assert.is_nil(err)
      assert.equals("", val)
    end)

    it("should unescape XML entities in strings", function()
      local val, err = deserialization.deserializeXML("<string>&lt;tag&gt;&amp;&quot;test&apos;</string>")
      assert.is_nil(err)
      assert.equals('<tag>&"test\'', val)
    end)

    it("should deserialize sequence tables", function()
      local val, err = deserialization.deserializeXML("<table><integer>1</integer><integer>2</integer><integer>3</integer></table>")
      assert.is_nil(err)
      assert.are.same({1, 2, 3}, val)
    end)

    it("should deserialize map tables with key_value", function()
      local val, err = deserialization.deserializeXML("<table><key_value><string>a</string><integer>1</integer></key_value></table>")
      assert.is_nil(err)
      assert.equals(1, val.a)
    end)

    it("should deserialize mixed tables", function()
      local val, err = deserialization.deserializeXML("<table><integer>1</integer><integer>2</integer><key_value><string>a</string><string>test</string></key_value></table>")
      assert.is_nil(err)
      assert.equals(1, val[1])
      assert.equals(2, val[2])
      assert.equals("test", val.a)
    ...
    it("should deserialize nested tables", function()
      local val, err = deserialization.deserializeXML("<table><table><integer>1</integer><integer>2</integer></table></table>")
      assert.is_nil(err)
      assert.are.same({{1, 2}}, val)
    end)

    it("should return error for non-string input", function()
      local val, err = deserialization.deserializeXML(123)
      assert.is_nil(val)
      assert.is_not_nil(err)
      assert.matches("not a string", err)
    end)
    ...
    it("should return error for missing opening tag", function()
      local val, err = deserialization.deserializeXML("not a tag")
      assert.is_nil(val)
      assert.is_not_nil(err)
    ...
    it("should return error for malformed tag", function()
      local val, err = deserialization.deserializeXML("<malformed")
      assert.is_nil(val)
      assert.is_not_nil(err)
    ...
    it("should return error for unknown self-closing tag", function()
      local val, err = deserialization.deserializeXML("<unknown_tag/>")
      assert.is_nil(val)
      assert.is_not_nil(err)
    ...
    it("should return error for unclosed tag", function()
      ...
      local val, err = deserialization.deserializeXML("<integer")
      assert.is_nil(val)
      assert.is_not_nil(err)
      assert.matches("Malformed tag", err)
    end)
    ...
    it("should return error for tag with missing close bracket", function()
      local val, err = deserialization.deserializeXML("<integer 42")
      assert.is_nil(val)
      assert.is_not_nil(err)
    ...
    it("should return error for missing closing float tag", function()
      local val, err = deserialization.deserializeXML("<float>3.14")
      assert.is_nil(val)
      assert.is_not_nil(err)
      assert.matches("Missing closing tag for float", err)
    end)

    it("should return error for missing closing string tag", function()
      local val, err = deserialization.deserializeXML("<string>hello")
      assert.is_nil(val)
      assert.is_not_nil(err)
    ...
    it("should return error for missing closing table tag", function()
      local val, err = deserialization.deserializeXML("<table><integer>1</integer>")
      assert.is_nil(val)
      assert.is_not_nil(err)
    ...
    it("should return error for missing closing key_value tag", function()
      local val, err = deserialization.deserializeXML("<table><key_value><string>key</string><integer>1</integer></table>")
      assert.is_nil(val)
      assert.is_not_nil(err)
    ...
    it("should return error for unknown tag type", function()
      local val, err = deserialization.deserializeXML("<foobar>content</foobar>")
      assert.is_nil(val)
      assert.is_not_nil(err)
    ...
    it("should return error for missing closing null tag", function()
      local val, err = deserialization.deserializeXML("<null>content")
      assert.is_nil(val)
      assert.is_not_nil(err)
    ...
    it("should return error for missing closing true tag", function()
      local val, err = deserialization.deserializeXML("<true>content")
      assert.is_nil(val)
      assert.is_not_nil(err)
    ...
    it("should return error for missing closing false tag", function()
      local val, err = deserialization.deserializeXML("<false>content")
      assert.is_nil(val)
      assert.is_not_nil(err)
    ...
    it("should return error for missing closing function tag", function()
      local val, err = deserialization.deserializeXML("<function>content")
      assert.is_nil(val)
      assert.is_not_nil(err)
