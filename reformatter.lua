...
local function generateUsage()
    ...
    table.insert(lines, "  lua reformatter.lua data/")
    table.insert(lines, "      Reformat files in data/ directory (no export)")
    table.insert(lines, "")
    table.insert(lines, "  lua reformatter.lua --file=json data/")
    table.insert(lines, "      Export as JSON (natural format) to exported/json-json-natural/")
    table.insert(lines, "")
    table.insert(lines, "  lua reformatter.lua --file=json --data=json-typed data/")
    table.insert(lines, "      Export as JSON (typed format) to exported/json-json-typed/")
    table.insert(lines, "")
    table.insert(lines, "  lua reformatter.lua --file=tsv --data=lua data/")
    table.insert(lines, "      Export as TSV with Lua literals to exported/tsv-lua/")
    table.insert(lines, "")
    table.insert(lines, "  lua reformatter.lua --file=sql --data=json-natural --export-dir=db data/")
    table.insert(lines, "      Export as SQL with JSON columns to db/sql-json-natural/")
    table.insert(lines, "")
    table.insert(lines, "  lua reformatter.lua --file=lua --file=json data/")
