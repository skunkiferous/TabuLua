...
| [manifest_info](#manifest_info) | Package metadata, versioning, and dependencies | error_reporting, file_util, lua_cog, named_logger, parsers, raw_tsv, read_only, tsv_model |
| [manifest_loader](#manifest_loader) | Package loading orchestration and dependency resolution | error_reporting, file_util, files_desc, lua_cog, manifest_info, parsers, raw_tsv, read_only, table_utils, tsv_model |
| [named_logger](#named_logger) | Logging system with named loggers and levels | *(none)* |
| [number_identifiers](#number_identifiers) | Numeric/string identifier conversion | read_only |
| [parsers](#parsers) | Main entry point for type parsing system | parsers.*, read_only |
| [parsers.builtin](#parsersbuiltin) | Built-in type parsers (boolean, number, string, etc.) | parsers.registration, parsers.state, parsers.type_parsing, parsers.utils, predicates, regex_utils |
| [parsers.generators](#parsersgenerators) | Factory functions for specialized parsers | comparators, parsers.introspection, parsers.lpeg_parser, parsers.state, parsers.type_parsing, parsers.utils, serialization |
...
| [parsers.registration](#parsersregistration) | Type alias and custom parser registration | comparators, parsers.generators, parsers.introspection, parsers.state, parsers.utils, serialization |
...
| [regex_utils](#regex_utils) | Lua pattern to PCRE translation | named_logger, predicates, read_only, sparse_sequence |
...
| [serialization](#serialization) | Data serialization (Lua, JSON, XML, SQL, MessagePack) | named_logger, predicates, read_only, sparse_sequence |
...
| [tsv_model](#tsv_model) | TSV loading with type validation and expressions | named_logger, predicates, raw_tsv, read_only, string_utils, table_utils |
...
**Dependencies:** file_util, named_logger, parsers, raw_tsv, read_only, serialization, tsv_model
...
**Dependencies:** error_reporting, file_util, lua_cog, named_logger, parsers, raw_tsv, read_only, tsv_model
...
Orchestrates package loading: discovers packages, resolves dependencies, registers types, and loads data files in order.

**Dependencies:** error_reporting, file_util, files_desc, lua_cog, manifest_info, parsers, raw_tsv, read_only, table_utils, tsv_model
...
**Dependencies:** comparators, parsers.introspection, parsers.lpeg_parser, parsers.state, parsers.type_parsing, parsers.utils, serialization
...
**Dependencies:** comparators, parsers.generators, parsers.introspection, parsers.state, parsers.utils, serialization
...
**Dependencies:** named_logger, predicates, read_only, sparse_sequence
...
**Dependencies:** named_logger, predicates, raw_tsv, read_only, string_utils, table_utils
...
- **sandbox** - Sandboxed Lua execution (used by lua_cog, tsv_model, table_parsing)
